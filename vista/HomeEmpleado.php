  ...
  <div class="container">
          ...
          <li>
            <div class="user-view">
             ...
             &nbsp;
               ...
               <li id="Opciones"><a class=" waves-effect waves-teal" href="solinombre.php"><i class="material-icons">face</i>Cambiar nombre </a></li>
               <li><div class="divider"></div></li>
               ...
               <li><div class="divider"></div></li>
               <li id="Opciones"><a  class=" waves-effect waves-teal" href="consultapro.php"><i class="material-icons">account_box</i>Consultar productos</a></li>
               <li><div class="divider"></div></li>
    ...
    <div class="row center">
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
        ...
        <h4>BIENVENIDO EMPLEADO </h4> <?php echo "<h3 style=\"color: blue\">$usuario</h3>" ?> <h4>A LA PLATAFORMA WEB DE GESTIÓN </h4>
        &nbsp;
