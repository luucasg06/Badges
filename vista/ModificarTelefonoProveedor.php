      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          <div> 
            ...
            <center>
                ...
                <img src="../estilos/images/tel.png" width="250" height="250">
                ...
                <table class="tc">
                  ...
                  <tr>
                    <td>TELÉFONO:</td>
                    <td><input  class="inc" width="250" type="text" name="telP" id="user"placeholder="Ej: 8888888"  ></td>
                  </tr>
                 </table>
                <input  class="boton" type="submit" name="boton" value="MODIFICAR-TELEFONO" >
                </form>
              </center>
