...
<head>
  <title>Gestión Total: Registrar Producto</title>
   ...
   <div class="row center">
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          <div> 
            ...
            <center>
                <form enctype="multipart/form-data" action="RecibirGestionProductos.php" method="post" onsubmit="return ValidarUser();">
                <img src="../estilos/images/window.png" width="250" height="250">
            <table>
               
                <table class="tc">
                  <tr>
                    <td>NOMBRE:</td>
                    <td><input title="Es obligatorio el nombre" class="inc" width="250" type="text" name="nombre" id="name"placeholder="Ej: Tela" required ></td>
                  </tr>
                  <tr>
                    <td>IMAGEN:</td>
