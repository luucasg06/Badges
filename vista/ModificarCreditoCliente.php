...
<head>
  <title>Gestión Total: Consultar Clientes</title>
  ...
  <div class="container">
   ...
   <div class="row center">
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          <div> 
            <h4>MODIFICAR CRÉDITO</h4>
            <center>
                <form action="RecibirGestionClientes.php" method="post" onsubmit="return ValidarContra();">
                <img src="../estilos/images/cre.png" width="250" height="250">
                <table class="tc">
                  <tr>
                    <td>ID USUARIO:</td>
                    <td><input  class="inc" width="250" type="text" name="idCliente" id="user"placeholder="Ej: 15"  ></td>
                  </tr>
                  <tr>
                    <td>TOPE DE CRÉDITO:</td>
                    <td><input  class="inc" width="250" type="text" name="credC" id="user"placeholder="Ej: 10000"></td>
                  </tr>
                 </table>
                <input  class="boton" type="submit" name="boton" value="MODIFICAR-CREDITO" >
                </form>
              </center>
