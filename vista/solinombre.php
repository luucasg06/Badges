...
<head>
  <title>Gestión Total: Solicitud cambio de nombre</title>
  ...
  <!-- Menu lateral-->
             ...
             <br/>
               ...
               <?php
                  if(isset($_SESSION["UsuEmp"])){
                    ?>
                      <li  id="Opciones"><a  class=" waves-effect waves-teal" href="consultaprov.php"><i class="material-icons">assignment_ind</i>Consultar proveedor</a></li>
                      <li><div class="divider"></div></li>
                    <?php
                  } 
               ?>
               <?php
                  if(isset($_SESSION["UsuProv"])){
                    ?>
                      <li  id="Opciones"><a  class=" waves-effect waves-teal" href="consultacli.php"><i class="material-icons">assignment_ind</i>Consultar clientes</a></li>
                      <li><div class="divider"></div></li>
                    <?php
                  } 
               ?>
   ...
   <div class="row center">
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          <div> 
            <h4>Solicitud de cambio de nombre</h4>
            <center>
                <form  action="RecibirSolicitudes.php" method="post" onsubmit="return ValidarTipo();">
                <img src="../estilos/images/soli.png" width="250" height="250">
            <table>
               
                <table class="tc">
                  <tr>
                    <td>Nombre actual:</td>
                    <td><input type="text" disabled class="inc" width="250" type="text" name="nombrea" id="nombrea" value="<?php echo $usuario ?>" required ></td>
                  </tr>
                  <tr>
                    <td>Nombre nuevo: </td>
                     <td><input class="inc" id="nombren" width="250" type="text" name="nombren" required></td>
                  </tr>
                 
                 </table>
                <input  class="boton" type="submit" name="boton" id="boton" value="SOLICITUD-NOMBRE" >
                </form>
              </center>
