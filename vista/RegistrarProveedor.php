...
<head>
  <title>Gestión Total: Registrar Proveedor</title>
   ...
   <div class="row center">
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          <div> 
            ...
            <center>
                <form enctype="multipart/form-data" action="RecibirGestionProveedor.php" method="post" onsubmit="return ValidarTipo();">
                <img src="../estilos/images/registration.png" width="250" height="250">
                ...
                <table class="tc">
                  ...
                  <tr>
                    <td>TIPO DE PROVEEDOR:</td>
                     <td><input class="inc" id="tipo" width="250" type="text" name="tpro" placeholder="NATURAL/JURIDICO" required></td>
                  </tr>
                   <tr>
