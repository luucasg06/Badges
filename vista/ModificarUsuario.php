...
<head>
  <title>Gestión Total: Modificar Usuario</title>
  ...
  <div class="container">
   ...
   <div class="row center">
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          <div> 
            <h4>MODIFICAR CONTRASEÑA DE USUARIO</h4>
            <center>
                <form action="RecibirGestionUsuarios.php" method="post" onsubmit="return ValidarContra();">
                <img src="../estilos/images/contrasenaU.png" width="250" height="250">
            <table>
               
                <table class="tc">
                  <tr>
                    <td>USUARIO:</td>
                    <td><input title="Es obligatorio el nombre" class="inc" width="250" type="text" name="nombre" id="user"placeholder="Ej: Juan98" required ></td>
                  </tr>
                  <tr>
                    <td>CONTRASEÑA ACTUAL:</td>
                     <td><input class="inc" id="con" width="250" type="password" name="contra" placeholder="Ingrese su antigua contraseña" required></td>
                  </tr>
                   <tr>
                    <td>CONTRASEÑA NUEVA:</td>
                     <td><input class="inc" id="conn" width="250" type="password" name="contran" placeholder="Ingrese su nueva contraseña" required></td>
                  </tr>
                  <tr>
                    <td>REPETIR CONTRASEÑA NUEVA:</td>
                     <td><input class="inc" id="conf" width="250" type="password" name="contran2" placeholder="Repetir contraseña nueva" required></td>
                  </tr>
                 </table>
                <input  class="boton" type="submit" name="boton" value="MODIFICAR" >
                </form>
              </center>
