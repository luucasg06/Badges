...
<head>
  <title>Gestión Total: Consultar Empleado</title>
  ...
  <div class="container">
   ...
   <div class="row center">
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          <div> 
            <h4>CONSULTAR EMPLEADOS</h4>
            <center>
                <form action="RecibirGestionEmpleados.php" method="post" onsubmit="return ValidarContra();">
                <img src="../estilos/images/co.png" width="250" height="250">
            
               
                <table class="tc">
                  <tr>
                    <td>NOMBRE:</td>
                    <td><input  class="inc" width="250" type="text" name="nombre" id="user"placeholder="Ej: Juan"  ></td>
                  </tr>
               
                 </table>
                <input  class="boton" type="submit" name="boton" value="CONSULTAR" >
                <input  class="boton" type="submit" name="boton" value="CONSULTARTODOS" >
                </form>
              </center>
