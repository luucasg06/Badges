      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          ...
          <div> 
            ...
            <center>
                ...
                <img src="../estilos/images/GestionH.png" width="250" height="250">
            <table>
               
                <table class="tc">
                  <tr>
                  
                    <td><form action="ModificarClientes.php"> <input  class="boton" type="submit" name="boton" value="Modificar"></form></td>
                    <td><form action="ConsultarClientes.php"> <input  class="boton" type="submit" name="boton" value="Consultar"></form></td>
                    <td><form action="DesactivarCliente.php"> <input  class="boton" type="submit" name="boton" value="Desactivar"></form></td>
                 </tr>
                 </table>
