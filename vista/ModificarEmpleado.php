...
<head>
  <title>Gestión Total: Modificar Empleado</title>
  ...
  <div class="container">
   ...
   <div class="row center">
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          <div> 
            <h4>Modificación de Datos: Empleados</h4>
            <center>
                
                <img src="../estilos/images/process.png" width="250" height="250">
            <table>
               
                <table class="tc">
                  <tr>
                    <td><form action="ModificarNombreEmpleado.php"> <input  class="boton" type="submit" name="boton" value="NOMBRE"></form></td>
                    <td><form action="ModificarIngresoEmpleado.php"> <input  class="boton" type="submit" name="boton" value="FECHA INGRESO"></form></td>
                    <td><form action="ModificarSalarioEmpleado.php"> <input  class="boton" type="submit" name="boton" value="SALARIO"></form></td>
                    <td><form action="ModificarDeduccionEmpleado.php"> <input  class="boton" type="submit" name="boton" value="DEDUCCION"></form></td>
                    <td><form action="ModificarFotoEmpleado.php"> <input  class="boton" type="submit" name="boton" value="FOTO"></form></td>
                    <td><form action="ModificarHVEmpleado.php"> <input  class="boton" type="submit" name="boton" value="HV"></form></td>
                    <td><form action="ModificarEmailEmpleado.php"> <input  class="boton" type="submit" name="boton" value="EMAIL"></form></td>
                    <td> <form action="ModificarTelefonoEmpleado.php"><input  class="boton" type="submit" name="boton" value="TELEFONO"></form></td>
                    <td><form action="ModificarMovilEmpleado.php"> <input  class="boton" type="submit" name="boton" value="MOVIL"></form></td>
                 </tr>
                 </table>       
              </center>
