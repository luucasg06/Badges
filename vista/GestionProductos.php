...
<head>
  <title>Gestión Total: Productos</title>
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          ...
          <div> 
            ...
            <center>
                ...
                <img src="../estilos/images/product.png" width="250" height="250">
            <table>
               
                <table class="tc">
                  <tr>
                    <td><form action="RegistrarProducto.php"> <input  class="boton" type="submit" name="boton" value="Registrar"></form></td>
                    <td><form action="ModificarProductos.php"> <input  class="boton" type="submit" name="boton" value="Modificar"></form></td>
                    <td><form action="ConsultarProductos.php"> <input  class="boton" type="submit" name="boton" value="Consultar"></form></td>
                    <td><form action="#"> <input  class="boton" type="submit" name="boton" value="Borrar"></form></td>
                 </tr>
                 </table>
