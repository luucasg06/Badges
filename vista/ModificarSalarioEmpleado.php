  ...
  <div class="container">
   ...
   <div class="row center">
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          <div> 
            <h4>MODIFICAR SALARIO BÁSICO</h4>
            <center>
                <form action="RecibirGestionEmpleados.php" method="post" onsubmit="return ValidarContra();">
                <img src="../estilos/images/money.png" width="250" height="250">
                ...
                <table class="tc">
                  ...
                  <tr>
                    ...
                    <td><input  class="inc" width="250" type="text" name="salE" id="user"placeholder="Ej: 1200000"  ></td>
                  </tr>
                 </table>
                <input  class="boton" type="submit" name="boton" value="MODIFICAR-SALARIO" >
                </form>
              </center>  
