...
<head>
  <title>Gestión Total: Eliminar Usuario </title>
  ...
  <div class="container">
   ...
   <div class="row center">
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          <div> 
            <h4>ELIMINAR USUARIO DEL SISTEMA</h4>
            <center>
                <form action="RecibirGestionUsuarios.php" method="post" onsubmit="return ValidarEliminarU();">
                <img src="../estilos/images/eliminarU.png" width="250" height="250">
            <table>
                ...
                <table class="tc">
                  ...
                  <tr>
                    <td>CONTRASEÑA:</td>
                     <td><input class="inc" id="con" width="250" type="password" name="contra" placeholder="Ingrese la contraseña" required ></td>
                  </tr>
                 </table>
                <input  class="boton" type="submit" name="boton" value="BORRAR" >
                </form>
              </center>
