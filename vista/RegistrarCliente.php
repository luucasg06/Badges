...
<head>
  <title>Gestión Total: Registrar Cliente</title>
  ...
  <link rel="stylesheet" href="../estilos/css/mapita.css">
  <meta charset="utf-8">
</head>
   ...
   <div class="row center">
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          <div> 
            ...
            <center>
                <form enctype="multipart/form-data" action="RecibirGestionClientes.php" method="post" onsubmit="return ValidarTipo();">
                <img src="../estilos/images/reg.png" width="250" height="250">
            <table>
                ...
                <table class="tc">
                  ...
                  <tr>
                    <td>TIPO CLIENTE:</td>
                     <td><input class="inc" id="tipo" width="250" type="text" name="tcli" placeholder="NATURAL/JURIDICO" required></td>
                  </tr>
                   <tr>
                    <td>FECHA REGISTRO</td>
                    <td><input class="inc" id="fres" width="250" type="Date" name="fechaR"  required></td>
                  </tr>
                   <tr>
                    <td>FECHA INACTIVO:</td>
                    <td><input class="inc" id="fina" width="250" type="date" name="fechaI"></td>
                  </tr>
                   <tr>
                    <td>IMAGEN:</td>
                    <td><input class="inc" id="archivo" width="250" type="File" name="archivo" value="foto" accept="image/*" required></td>
                  </tr>
                   <tr>
                    <td>E-MAIL:</td>
                    <td><input class="inc" id="mail" width="250" type="text" name="email" placeholder="Ej: ejemploGestion@outlook.com" required></td>
                  </tr>
                   <tr>
                    <td>TELÉFONO</td>
                    <td><input class="inc" id="tel" width="250" type="text" name="Tele" placeholder="Ej: 3015476574" required></td>
                  </tr>
                   <tr>
                    <td>TOPE CREDITO</td>
                    <td><input class="inc" id="cre" width="250" type="text" name="cupo" placeholder="Ej:100000" required></td>
                    </tr>
                  ...
                  <tr>
                    ...
                    <td>ID USUARIO:</td>
                    <td><input class="inc" id="iper" width="250" type="hidden" name="iper" value="<?php echo $idT;?>"><center><font color="blue" style="font-size: 20px; font-weight: bold" ><?php echo $idT;?></font></center></td>
                  </tr>
                 </table>
