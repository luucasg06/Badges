...
<head>
  <title>Gestión Total: Modificar Proveedor</title>
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          <div> 
            ...
            <center>
              ...
              <img src="../estilos/images/tipo.png" width="250" height="250">  
                               
                <table class="tc">
                  <tr>
                    <td>ID USUARIO:</td>
                    <td><input  class="inc" width="250" type="text" name="idProveedor" id="user"placeholder="Ej: 15"  ></td>
                  </tr>
                  <tr>
                ...
                <input  class="boton" type="submit" name="boton" value="MODIFICAR-TIPO" >
              </form>
            </center>
