...
<head>
  <title>Gestión Total: Registrar Usuario</title>
   ...
   <div class="row center">
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          <div> 
            ...
            <center>
                <form action="RecibirGestionUsuarios.php" method="post" onsubmit="return ValidarUser();">
                <img src="../estilos/images/registrarU.png" width="250" height="250">
            <table>
                ...
                <table class="tc">
                  ...
                  <tr>
                    <td>CONTRASEÑA:</td>
                     <td><input class="inc" id="con" width="250" type="password" name="contra" placeholder="Ingrese una contraseña" required ></td>
                  </tr>
                   <tr>
                    <td>TIPO PERFIL</td>
                    <td><input class="inc" id="tper" width="400" type="number" name="tper" min="1" max="5" placeholder="1.Admin 2.Empl 3.Clt 4.Prov" required></td>
                  </tr>
                 </table>
