  ...
  <div class="container">
    ...
    <!-- Fin menu lateral-->
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          ...
          <div> 
            <h4>Modificación de Datos: Productos</h4>
            <center>
                
                <img src="../estilos/images/transformation.png" width="250" height="250">
            <table>
               
                <table class="tc">
                  <tr>
                    <td><form action="ModificarNombreProducto.php"> <input  class="boton" type="submit" name="boton" value="Nombre"></form></td>
                    <td><form action="ModificarFotoProducto.php"> <input  class="boton" type="submit" name="boton" value="Foto"></form></td>
                 </tr>
                 </table>
