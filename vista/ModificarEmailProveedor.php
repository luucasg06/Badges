...
<head>
  <title>Gestión Total: Consultar Proveedor</title>
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          <div> 
            ...
            <center>
                ...
                <img src="../estilos/images/ema.png" width="250" height="250">
                ...
                <table class="tc">
                  ...
                  <tr>
                    <td>EMAIL:</td>
                    <td><input  class="inc" width="250" type="text" name="emailC" id="user"placeholder="Ej: gestTotal@outlook.com"></td>
                  </tr>
                 </table>
                <input  class="boton" type="submit" name="boton" value="MODIFICAR-EMAIL" >
                </form>
              </center>
