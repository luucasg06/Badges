...
<head>
  <title>Gestión Total: Registrar empleado</title>
   ...
   <div class="row center">
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          <div> 
            ...
            <center>
                <form enctype="multipart/form-data" action="RecibirGestionEmpleados.php" method="post">
                <img src="../estilos/images/re.png" width="250" height="250">
            <table>
               
                <table class="tc">
                  <tr>
                    <td>NOMBRE:</td>
                    <td><input title="Es obligatorio el nombre" class="inc" width="250" type="text" name="nombre" id="name"placeholder="Ej: Juan López" required ></td>
                  </tr>
                  <tr>
                    <td>FECHA DE INGRESO:</td>
                     <td><input class="inc" id="fechaR" width="250" type="date" name="fechaR" required></td>
                  </tr>
                   <tr>
                    <td>FECHA RETIRO</td>
                    <td><input class="inc" id="fechaI" width="250" type="Date" name="fechaI"></td>
                  </tr>
                   <tr>
                    <td>SALARIO BÁSICO:</td>
                    <td><input class="inc" id="salB" width="250" type="number" name="salB" placeholder="Ej: 1200000" required></td>
                  </tr>
                   <tr>
                    <td>DEDUCCIONES:</td>
                    <td><input class="inc" id="deduc" width="250" type="number" name="deduc" placeholder="Ej: 100000" required></td>
                  </tr>
                   <tr>
                    <td>IMAGEN:</td>
                    <td><input class="inc" id="archivo" width="250" type="File" name="archivo[]" accept="image/*"  value="foto" required></td>
                  </tr>
                   <tr>
                    <td>HOJA DE VIDA:</td>
                    <td><input class="inc" id="archivo" width="250" type="File" name="archivo[]" accept="application/pdf" required></td>
                  </tr>
                   <tr>
                    <td>E-MAIL:</td>
                    <td><input class="inc" id="email" width="250" type="text" name="email"  placeholder="Ej: gestion@outlook.com" required></td>
                  </tr>
                    <tr>
                    <td>TELÉFONO:</td>
                    <td><input class="inc" id="Tele" width="250" type="number" name="Tele"   placeholder="Ej: 3224455" required></td>
                  </tr>
                  <tr>
                    <td>CELULAR:</td>
                    <td><input class="inc" id="cel" width="250" type="number" name="cel"  placeholder="Ej: 3015476574" required></td>
                  </tr>
                   <tr>
                    <td>LATITUD </td>
                    <td><input class="inc" id="lat" width="250" type="text" name="lat"  required></td>
                  </tr>
                   <tr>
                    <td>LONGITUD</td>
                    <td><input class="inc" id="long" width="250" type="text" name="long" required></td>
                  </tr>
                  <tr>
                    <?php
                    $idT=$_POST['idH'];
                    ?>
                    <input type="hidden" id="hola">
                    <td>ID USUARIO:</td>
                    <td><input class="inc" id="hola" width="250" type="hidden" name="hola" value="<?php echo $idT;?>"><center><font color="blue" style="font-size: 20px; font-weight: bold" ><?php echo $idT;?></font></center></td>
                  </tr>
                 </table>
