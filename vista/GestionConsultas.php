...
<head>
  <title>Gestión Total: Consultas</title>
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          ...
          <div> 
            ...
            <center>
                ...
                <img src="../estilos/images/Consultas.png" width="300" height="250">
            <table>
               
                <table class="tc">
                  <tr>
                  
                    <td><form action="Consultaclientes.php" target="_blank"> <input  class="boton" type="submit" name="boton"  value="Consultar clientes"></form></td>
                    <td><form action="ConsultaUbiEmpleados.php" target="_blank"> <input  class="boton" type="submit" name="boton" value="Consultar empleados"></form></td>
                    <td><form action="ConsultaUbiProv.php" target="_blank"> <input  class="boton" type="submit" name="boton" value="Consultar proveedores"></form></td>
                 </tr>
                 </table>
