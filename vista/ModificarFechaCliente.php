          ...
          <div> 
            ...
            <center>
                ...
                <table class="tc">
                  <tr>
                    <td>ID USUARIO:</td>
                    <td><input  class="inc" width="250" type="text" name="idCliente" id="user"placeholder="Ej: 10"  ></td>
                  </tr>
                  <tr>
                    <td>FECHA INACTIVIDAD:</td>
                    <td><input  class="inc" width="250" type="date" name="fechaIn" id="user"  ></td>
                  </tr>
                 </table>
                <input  class="boton" type="submit" name="boton" value="MODIFICARFECHA" >
                </form>
              </center>
