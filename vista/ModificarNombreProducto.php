   ...
   <div class="row center">
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          <div> 
            ...
            <center>
                <form action="RecibirGestionProductos.php" method="post" onsubmit="return ValidarContra();">
                <img src="../estilos/images/text.png" width="250" height="250">
               
                <table class="tc">
                  <tr>
                    <td>ID Producto:</td>
                    <td><input  class="inc" width="250" type="text" name="idProducto" id="user"placeholder="Ej: 15"  ></td>
                  </tr>
                  <tr>
                    <td>NOMBRE:</td>
                    <td><input  class="inc" width="250" type="text" name="nombreP" id="user"placeholder="Ej: Tela"></td>
                  </tr>
                 </table>
