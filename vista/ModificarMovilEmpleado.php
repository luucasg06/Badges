          ...
          <div> 
            ...
            <center>
                ...
                <table class="tc">
                  ...
                  <tr>
                    <td>MÓVIL:</td>
                    <td><input  class="inc" width="250" type="text" name="movilE" id="user"placeholder="Ej: 3015444444"  ></td>
                  </tr>
                 </table>
                <input  class="boton" type="submit" name="boton" value="MODIFICAR-MOVIL" >
                </form>
              </center>
