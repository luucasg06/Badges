      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          <div> 
            ...
            <center>
                ...
                <img src="../estilos/images/text.png" width="250" height="250">
                ...
                <table class="tc">
                  ...
                  <tr>
                    <td>NOMBRE:</td>
                    <td><input  class="inc" width="250" type="text" name="nombreP" id="user"placeholder="Ej: Pepito Pérez"></td>
                  </tr>
                 </table>
                <input  class="boton" type="submit" name="boton" value="MODIFICAR-NOMBRE" >
                </form>
              </center>
