...
<head>
  <title>Gestión Total: Proveedores</title>
  ...
  <div class="container">
    ...
    <!-- Fin menu lateral-->
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          ...
          <div> 
            <h4>Modificación de Datos: Proveedores</h4>
            <center>
                
                <img src="../estilos/images/Exchange.png" width="250" height="250">
            <table>
               
                <table class="tc">
                  <tr>
                    <td><form action="ModificarNombreProveedor.php"> <input  class="boton" type="submit" name="boton" value="Nombre"></form></td>
                    <td><form action="ModificarTipoProveedor.php"> <input  class="boton" type="submit" name="boton" value="Tipo"></form></td>
                    <td><form action="ModificarIngresoProveedor.php"> <input  class="boton" type="submit" name="boton" value="Fecha de Ingreso"></form></td>
                    <td><form action="ModificarFotoProveedor.php"> <input  class="boton" type="submit" name="boton" value="Foto"></form></td>
                    <td><form action="ModificarEmailProveedor.php"> <input  class="boton" type="submit" name="boton" value="Email"></form></td>
                    <td> <form action="ModificarTelefonoProveedor.php"><input  class="boton" type="submit" name="boton" value="Telefono"></form></td>
                 </tr>
                 </table>
