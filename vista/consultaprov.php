  ...
  <!-- Menu lateral-->
             ...
             <br/>
               ...
               <?php
                  if(isset($_SESSION["UsuEmp"])){
                    ?>
                      <li  id="Opciones"><a  class=" waves-effect waves-teal" href="#"><i class="material-icons">assignment_ind</i>Consultar proveedor</a></li>
                      <li><div class="divider"></div></li>
                    <?php
                  } 
               ?>
   ...
   <div class="row center">
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          <div>
          <h4 style="color: green">LISTADO DE PROVEEDORES</h4> 
            <?php
