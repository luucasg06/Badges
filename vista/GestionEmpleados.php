...
<head>
  <title>Gestión Total: Empleados</title>
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          ...
          <div> 
            ...
            <center>
                ...
                <img src="../estilos/images/team.png" width="300" height="250">
            <table>
               
                <table class="tc">
                  <tr>
                  
                    <td><form action="ModificarEmpleado.php"> <input  class="boton" type="submit" name="boton" value="Modificar"></form></td>
                    <td><form action="ConsultarEmpleado.php"> <input  class="boton" type="submit" name="boton" value="Consultar"></form></td>
                    <td><form action="DesactivarEmpleado.php"> <input  class="boton" type="submit" name="boton" value="Desactivar"></form></td>
                 </tr>
                 </table>
