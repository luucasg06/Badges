  ...
  <div class="container">
   ...
   <div class="row center">
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          <div> 
            <h4>MODIFICAR DEDUCCIÓN</h4>
            <center>
                <form action="RecibirGestionEmpleados.php" method="post" onsubmit="return ValidarContra();">
                <img src="../estilos/images/lossmoney.png" width="250" height="250">
                ...
                <table class="tc">
                  ...
                  <tr>
                    <td>DEDUCCIÓN:</td>
                    <td><input  class="inc" width="250" type="text" name="deducE" id="user"placeholder="Ej: 200000"  ></td>
                  </tr>
                 </table>
                <input  class="boton" type="submit" name="boton" value="MODIFICAR-DEDUCCION" >
                </form>        
              </center>
