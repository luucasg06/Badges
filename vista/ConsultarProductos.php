...
<head>
  <title>Gestión Total: Consultar Productos</title>
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          <div> 
            ...
            <center>
                ...
                <img src="../estilos/images/busqpr.png" width="250" height="250">
            
               
                <table class="tc">
                  <tr>
                    <td>NOMBRE:</td>
                    <td><input  class="inc" width="250" type="text" name="nombre" id="user"placeholder="Ej: Tela"  ></td>
                  </tr>
