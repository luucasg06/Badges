...
<head>
  <title>Gestión Total: Agregar Producto </title>
   ...
   <div class="row center">
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          <div> 
            ...
            <h5>Nota: En este punto, se unen los productos que correspondan a un proveedor</h5>
            <h6>|Si no sabe los ID, consulte cada uno en su respectivo lugar|</h6>
            <center>
                <form action="RecibirGestionProveedor.php" method="post" onsubmit="return ValidarUser();">
                <img src="../estilos/images/client.png" width="250" height="250">
            <table>
               
                <table class="tc">
                  <tr>
                    <td>ID PROVEEDOR:</td>
                    <td><input title="Es obligatorio el nombre" class="inc" width="250" type="number" name="idProveedor" id="user"placeholder="Ej: 1"  required></td>
                  </tr>
                  <tr>
                    <td>ID PRODUCTO:</td>
                     <td><input class="inc" id="con" width="250" type="number" name="idProducto" placeholder="Ej: 5" required ></td>
                  </tr>
                 </table>
                <input  class="boton" type="submit" name="boton" value="AGREGAR-PRODUCTO" >
                </form>
              </center>
