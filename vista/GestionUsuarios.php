...
<head>
  <title>Gestión Total: Usuarios</title>
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          ...
          <div> 
            ...
            <center>
                ...
                <img src="../estilos/images/GestionU.png" width="250" height="250">
            <table>
               
                <table class="tc">
                  <tr>
                    <td><form action="RegistrarUsuario.php"> <input  class="boton" type="submit" name="boton" value="Registrar"></form></td>
                    <td><form action="ModificarUsuario.php"> <input  class="boton" type="submit" name="boton" value="Modificar Contraseña"></form></td>
                    <td><form action="ConsultarUsuario.php"> <input  class="boton" type="submit" name="boton" value="Consultar"></form></td>
                 </tr>
                 </table>
