  ...
  <div class="container">
   ...
   <div class="row center">
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          <div> 
            <h4>MODIFICAR FOTO</h4>
            <center>
                <form enctype="multipart/form-data" action="RecibirGestionProveedor.php" method="post">
                <img src="../estilos/images/empleado.png" width="250" height="250">  
                ...
                <input  class="boton" type="submit" name="boton" value="MODIFICAR-FOTO" >
                </form>
              </center>
