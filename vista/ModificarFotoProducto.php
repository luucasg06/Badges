...
<head>
  <title>Gestión Total: Modificar Producto</title>
   ...
   <div class="row center">
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          <div> 
            ...
            <center>
                <form enctype="multipart/form-data" action="RecibirGestionProductos.php" method="post">
                <img src="../estilos/images/description.png" width="250" height="250">  
