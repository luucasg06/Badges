  ...
  <!-- Menu lateral-->
             ...
             <br/>
               ...
               <?php
                  if(isset($_SESSION["UsuProv"])){
                    ?>
                      <li  id="Opciones"><a  class=" waves-effect waves-teal" href="#"><i class="material-icons">assignment_ind</i>Consultar clientes</a></li>
                      <li><div class="divider"></div></li>
                    <?php
                  } 
               ?>
   ...
   <div class="row center">
      ...
      <div class="col s10 m8 l0"> <!-- información en el centro -->
          <div>
          <h4 style="color: green">LISTADO DE CLIENTES</h4> 
            <?php
